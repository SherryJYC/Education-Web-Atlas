...
<!--     
    Add everthing that relates to this atlas project: The course, the aim of the project, 
    the involved persons, the software used, copyright notes. -->
    <div>
    <b-card
    ...
    <b-card-group deck>
      ...
      <b-card class="text">
        ...
        All charts and maps are produced by ourselves.<br/>
